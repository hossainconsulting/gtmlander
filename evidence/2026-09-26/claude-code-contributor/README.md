...
Environment/target: gtmlander (GitHub, branch main)
Starting state: README.md present
Changes made:
- README.md: added a Claude Code paragraph to the existing "Deployment and AI assistance" section.
- CLAUDE.md: added with repository-specific guidance (no AGENTS.md exists).
